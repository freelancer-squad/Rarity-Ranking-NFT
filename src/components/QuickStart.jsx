...
function HomePage() {
  ...
  const resolveLink = (url) => {
    return !!url && url.includes("ipfs://")
        ? url.replace("ipfs://", "https://gateway.ipfs.io/ipfs/") : url
  }
                  ...
                  return (
                    <>
                      ...
                      >
                        ...
                        >{`+${Number(e.rarityScore).toFixed(1)}`}</span>
                      </div>
                      <Alert
                        style={{
              ...
              return (
                <Card
                  ...
                  cover={
                    <Image
                      preview={false}
                      src={resolveLink(nft.attributes.image)}
